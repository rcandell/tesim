function xInitial = initial_conditions_controller(model_name)
% -------------------------------------------------------------------
%  Generated by MATLAB on 31-Dec-2014 11:16:11
...
xInitial.signals(1).blockName = ['te_plant/TE Plant/TE Code'];
